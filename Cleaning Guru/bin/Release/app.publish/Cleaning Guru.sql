/*
Deployment script for Cleaning Guru
*/
...
GO
PRINT N'Creating PK_Cleaners...';


GO
ALTER TABLE [dbo].[Cleaners]
    ADD CONSTRAINT [PK_Cleaners] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);
...
GO
PRINT N'Creating PK_Clients...';


GO
ALTER TABLE [dbo].[Clients]
    ADD CONSTRAINT [PK_Clients] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);
...
CREATE TABLE [dbo].[Jobs] (
    ...
    [QueryString] NVARCHAR (255)  NULL,
    [Recurance]   NVARCHAR (255)  NOT NULL,
    [IsDeleted]   BIT             NOT NULL,
    [Job_Cleaner] INT             NULL,
    [Job_Client]  INT             NOT NULL
);


GO
PRINT N'Creating PK_Jobs...';
...
GO
PRINT N'Creating DF_Cleaners_FirstName...';


GO
ALTER TABLE [dbo].[Cleaners]
    ADD CONSTRAINT [DF_Cleaners_FirstName] DEFAULT ('') FOR [FirstName];


GO
PRINT N'Creating DF_Cleaners_LastName...';


GO
ALTER TABLE [dbo].[Cleaners]
    ADD CONSTRAINT [DF_Cleaners_LastName] DEFAULT ('') FOR [LastName];


GO
PRINT N'Creating DF_Cleaners_HourlyRate...';


GO
ALTER TABLE [dbo].[Cleaners]
    ADD CONSTRAINT [DF_Cleaners_HourlyRate] DEFAULT ((0)) FOR [HourlyRate];


GO
PRINT N'Creating DF_Cleaners_StartDate...';


GO
ALTER TABLE [dbo].[Cleaners]
    ADD CONSTRAINT [DF_Cleaners_StartDate] DEFAULT ((0)) FOR [StartDate];


GO
PRINT N'Creating DF_Cleaners_Phone...';


GO
ALTER TABLE [dbo].[Cleaners]
    ADD CONSTRAINT [DF_Cleaners_Phone] DEFAULT ('') FOR [Phone];


GO
PRINT N'Creating DF_Cleaners_Email...';


GO
ALTER TABLE [dbo].[Cleaners]
    ADD CONSTRAINT [DF_Cleaners_Email] DEFAULT ('') FOR [Email];


GO
PRINT N'Creating DF_Cleaners_AddressLine1...';


GO
ALTER TABLE [dbo].[Cleaners]
    ADD CONSTRAINT [DF_Cleaners_AddressLine1] DEFAULT ('') FOR [AddressLine1];


GO
PRINT N'Creating DF_Cleaners_City...';


GO
ALTER TABLE [dbo].[Cleaners]
    ADD CONSTRAINT [DF_Cleaners_City] DEFAULT ('') FOR [City];


GO
PRINT N'Creating DF_Cleaners_Postcode...';


GO
ALTER TABLE [dbo].[Cleaners]
    ADD CONSTRAINT [DF_Cleaners_Postcode] DEFAULT ('') FOR [Postcode];


GO
PRINT N'Creating DF_Cleaners_CountryRegion...';


GO
ALTER TABLE [dbo].[Cleaners]
    ADD CONSTRAINT [DF_Cleaners_CountryRegion] DEFAULT ('') FOR [CountryRegion];


GO
PRINT N'Creating DF_Clients_Name...';


GO
ALTER TABLE [dbo].[Clients]
    ADD CONSTRAINT [DF_Clients_Name] DEFAULT ('') FOR [Name];


GO
PRINT N'Creating DF_Clients_Address1...';


GO
ALTER TABLE [dbo].[Clients]
    ADD CONSTRAINT [DF_Clients_Address1] DEFAULT ('') FOR [Address1];


GO
PRINT N'Creating DF_Clients_City...';


GO
ALTER TABLE [dbo].[Clients]
    ADD CONSTRAINT [DF_Clients_City] DEFAULT ('') FOR [City];


GO
PRINT N'Creating DF_Clients_Postcode...';


GO
ALTER TABLE [dbo].[Clients]
    ADD CONSTRAINT [DF_Clients_Postcode] DEFAULT ('') FOR [Postcode];


GO
PRINT N'Creating DF_Clients_Region...';


GO
ALTER TABLE [dbo].[Clients]
    ADD CONSTRAINT [DF_Clients_Region] DEFAULT ('') FOR [Region];


GO
PRINT N'Creating DF_Jobs_StartTime...';


GO
ALTER TABLE [dbo].[Jobs]
    ADD CONSTRAINT [DF_Jobs_StartTime] DEFAULT ((0)) FOR [StartTime];


GO
PRINT N'Creating DF_Jobs_EndTime...';


GO
ALTER TABLE [dbo].[Jobs]
    ADD CONSTRAINT [DF_Jobs_EndTime] DEFAULT ((0)) FOR [EndTime];


GO
PRINT N'Creating DF_Jobs_Price...';


GO
ALTER TABLE [dbo].[Jobs]
    ADD CONSTRAINT [DF_Jobs_Price] DEFAULT ((0)) FOR [Price];


GO
PRINT N'Creating DF_Jobs_Recurance...';


GO
ALTER TABLE [dbo].[Jobs]
    ADD CONSTRAINT [DF_Jobs_Recurance] DEFAULT ('') FOR [Recurance];


GO
PRINT N'Creating DF_Jobs_IsDeleted...';


GO
ALTER TABLE [dbo].[Jobs]
    ADD CONSTRAINT [DF_Jobs_IsDeleted] DEFAULT ((0)) FOR [IsDeleted];


GO
PRINT N'Creating DF_Jobs_Job_Client...';


GO
ALTER TABLE [dbo].[Jobs]
    ADD CONSTRAINT [DF_Jobs_Job_Client] DEFAULT ((0)) FOR [Job_Client];


GO
PRINT N'Creating Job_Cleaner...';


GO
ALTER TABLE [dbo].[Jobs] WITH NOCHECK
    ADD CONSTRAINT [Job_Cleaner] FOREIGN KEY ([Job_Cleaner]) REFERENCES [dbo].[Cleaners] ([Id]) ON DELETE NO ACTION ON UPDATE NO ACTION;


GO
PRINT N'Creating Job_Client...';


GO
ALTER TABLE [dbo].[Jobs] WITH NOCHECK
    ADD CONSTRAINT [Job_Client] FOREIGN KEY ([Job_Client]) REFERENCES [dbo].[Clients] ([Id]) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
GO
ALTER TABLE [dbo].[Jobs] WITH CHECK CHECK CONSTRAINT [Job_Cleaner];

ALTER TABLE [dbo].[Jobs] WITH CHECK CHECK CONSTRAINT [Job_Client];
